...
This dataset, published by the City Clerk's Office [@VoterStatistics] comprises the number of eligible voters and corrections/additions to the Voter’s List for the 2022 municipal election. The dataset is broken down by ward and voting subdivision. This data set was last refreshed on February 7, 2023 and captured for this paper on May 21, 2023. The total number of eligible electors in Toronto, by ward, subdivision, and the entire city are outlined in this data set. 
